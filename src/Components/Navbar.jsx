...
const Navbar = () => {
  const [collapsed, setCollapsed] = useState(true);
	...
	return (
		...
		<div className={`text-white md:p-1 transition-all duration-500 hover:bg-[#48c5ff] rounded-2xl overflow-hidden flex flex-col fixed md:top-4 bottom-4 left-4 right-4 md:w-64`}>
			...
			<ul className={`flex-grow h-2/3 md:block bg-slate-100 flex font-bold`}>
				
				<li className='flex-1 md:flex md:justify-normal'> 
					<button type='button' className='w-full h-full md:px-4 md:py-2 md:rounded-xl md:m-2 hover:bg-[#8bdaff] md:flex-1'> 
